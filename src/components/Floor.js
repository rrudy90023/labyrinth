...
export default class Floor extends Component {
	...
	render(){
		return (
			<a-scene vr-mode-ui="true" physics="friction: 0.3; restitution: 0.5; gravity:-100">

				<a-entity light="type: hemisphere; color: #929292; groundColor: #515151; intensity: 1.8" position="0 20 0"></a-entity>

				<a-sphere dynamic-body="mass:20000" position="-6.29 26 1.03" scale="1 1 1" color="yellow"></a-sphere>
